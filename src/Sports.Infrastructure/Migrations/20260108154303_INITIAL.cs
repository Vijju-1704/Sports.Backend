    ...
    public partial class INITIAL : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserEmployeeMap", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserEmployeeMap_EmployeeDirectory_EmployeeId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "EmployeeId", "Department", "Designation", "Email", "EmployeeCode", "FullName", "IsActive" },
                values: new object[,]
                {
                    { 1, "IT", "", "john.doe@techcorp.com", "EMP001", "John Doe", true },
                    { 2, "HR", "", "jane.smith@techcorp.com", "EMP002", "Jane Smith", true },
                    { 3, "Admin", "", "admin@techcorp.com", "EMP003", "System Admin", true }
                });

            migrationBuilder.InsertData(
                table: "Sports",
                columns: new[] { "SportId", "IconUrl", "Name", "Type" },
                values: new object[,]
                {
                    { 1, "🏏", "Cricket", "Team" },
                    { 2, "🏸", "Badminton", "Individual" },
                    { 3, "⚽", "Football", "Team" },
                    { 4, "🏓", "Table Tennis", "Individual" }
                });

            migrationBuilder.InsertData(
                table: "Venues",
                columns: new[] { "VenueId", "Address", "City", "Facilities", "MapsUrl", "Name" },
                values: new object[,]
                {
                    { 1, "", "Hyderabad", null, null, "Central Ground" },
                    { 2, "", "Bangalore", null, null, "Corporate Arena" }
                });
